...
class StressTest {
    ...
    void twentySettlementsStayCheap() {
        ...
        Kingdom kingdom = new Kingdom(Kingdom.Id.random(), "Stressland", "civilization:stress");
        for (int i = 0; i < 20; i++) {
            ...
            s.setStock(com.civilization.sim.settlement.TownStores.WOOD, 1_000_000);
            s.setStock(com.civilization.sim.settlement.TownStores.STONE, 1_000_000);
            for (int r = 0; r < 20; r++) {
