...
import com.civilization.sim.kingdom.ExpansionPlanner;
...
class ExpansionPlannerTest {
    ...
    private static Settlement fullSettlement(Kingdom kingdom) {
        ...
        s.addBuilding(new Building("civilization:town_hall", new SimPos(0, 64, 5), 0, true));
    ...
    void noExpansionWithoutAStandingHall() {
        Kingdom kingdom = new Kingdom(Kingdom.Id.random(), "Realm", "civilization:human/norman");
    ...
    void expansionIsDeterministic() {
        Kingdom a = new Kingdom(new Kingdom.Id(new UUID(7L, 7L)), "Realm", "civilization:human/norman");
        Kingdom b = new Kingdom(new Kingdom.Id(new UUID(7L, 7L)), "Realm", "civilization:human/norman");
