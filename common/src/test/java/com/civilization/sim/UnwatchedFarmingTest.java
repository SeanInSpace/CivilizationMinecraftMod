...
class UnwatchedFarmingTest {
    ...
    private static String census(Settlement town, long step) {
        return "step " + step + ": " + town.stage()
                ...
                + town.countBuildings("civilization:farm") + " fields and "
    ...
    void aFieldRipensTheWholeOfItselfOverTheRipeningTime() {
        Building farm = new Building("civilization:farm", new SimPos(20, 64, 0), 0, true);
    ...
    void aCampLeftEntirelyAloneAtTheShippedDefaultsFeedsItselfOffOneField() {
        ...
        assertTrue(camp.countBuildings("civilization:farm") > 1,
    ...
    void aCampWithFieldsToWorkProspersUnwatched() {
        Settlement camp = campOfFour();
        for (int i = 0; i < 3; i++) {
            camp.addBuilding(new Building("civilization:farm",
    ...
    private static Settlement oneFieldTown() {
        ...
        town.setFoodStock(0);
        town.addBuilding(new Building("civilization:farm", new SimPos(20, 64, 0), 0, true));
    ...
    private static Settlement seededVillage() {
        ...
        String[] plan = {"civilization:hearth", "civilization:granary", "civilization:farm",
                "civilization:farm", "civilization:farm", "civilization:house", "civilization:house",
                "civilization:house"};
