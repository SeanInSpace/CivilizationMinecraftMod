...
import com.civilization.sim.geom.Ways;
...
class WallShapeTest {
    ...
    private static Settlement aTownOnASlant() {
        ...
        String[] kinds = {"civilization:town_hall", "civilization:farm", "civilization:market",
                "civilization:granary", "civilization:town_hall", "civilization:farm",
                "civilization:farm", "civilization:town_hall", "civilization:house",
                "civilization:granary", "civilization:granary"};
    ...
    void noPostIsPlantedOnGroundTheTownHasAlreadyOrdered() {
        ...
        int span = BuildPlanner.plotSpanOf("civilization:house", town.catalog());
        assertTrue(town.isPlotFree(ordered, span, null),
                "the fixture orders a build on ground nothing else holds");
        town.enqueueUrgent(new BuildTask("civilization:house", ordered, 40));
