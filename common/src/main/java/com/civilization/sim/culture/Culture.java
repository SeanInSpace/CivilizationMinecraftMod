 ...
 * questions and the id says both: {@code civilization:human/norman} is the Norman
 ...
 *
 * <p>So the id is {@code civilization:<race>/<culture>}, and both halves are read
 ...
 *
 * @param id            the culture's identifier, {@code civilization:<race>/<culture>}
...
public record Culture(String id, List<String> pennedAnimals, List<String> layouts,
     ...
     * {@code civilization:orc/something} gets orcs without having to say so twice.
     ...
     * disagree: {@code civilization:human/highland} draws from {@code highland/}.
