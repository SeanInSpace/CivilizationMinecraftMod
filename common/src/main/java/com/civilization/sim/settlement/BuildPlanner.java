...
public final class BuildPlanner {
    ...
    public static final Map<String, String> PRODUCER_OF = Map.of(
            TownStores.WOOD, "civilization:lumber_camp",
            TownStores.STONE, "civilization:mine",
            TownStores.FOOD, "civilization:farm");
    ...
    public static final Map<String, Profession> TRADE_OF = Map.of(
            "civilization:lumber_camp", Profession.LUMBERJACK,
            "civilization:mine", Profession.MINER,
            "civilization:farm", Profession.FARMER);
    ...
    public static final String ACCESS_STAIRS = "civilization:stairs";
    ...
    /** "civilization:lumber_camp" reads as "lumber camp" in an event. */
    ...
    public static final String FARM = "civilization:farm";
