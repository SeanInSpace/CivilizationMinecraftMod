...
public final class StagePlanner {
    ...
    private static final Map<SettlementStage, List<Want>> PROGRAMS = Map.of(
            SettlementStage.CAMP, List.of(
                    new Want("civilization:camp_post", 1),
                    new Want("civilization:cache", 1)),
            SettlementStage.HOMESTEAD, List.of(
                    new Want("civilization:bunkhouse", 1),
                    new Want("civilization:hearth", 1),
                    new Want("civilization:farm", 1),
                    new Want("civilization:granary", 1)),
            SettlementStage.FORTIFIED, List.of(
                    ...
                    new Want("civilization:lumber_camp", 1),
                    new Want("civilization:storehouse", 1)),
            SettlementStage.VILLAGE, List.of(
                    new Want("civilization:cottage", 2),
                    new Want("civilization:mill", 1),
                    new Want("civilization:carpentry", 1),
                    new Want("civilization:market", 1),
                    new Want("civilization:inn", 1)),
            SettlementStage.TOWN, List.of(
                    new Want("civilization:town_hall", 1)));
    ...
    private static final List<String> WORKSHOPS =
            List.of("civilization:smith", "civilization:mill", "civilization:carpentry");
    ...
    public static boolean catalogAllows(SettlementStage stage, String blueprintId) {
        if (BuildPlanner.baseIdOf(blueprintId).equals("civilization:town_hall")) {
