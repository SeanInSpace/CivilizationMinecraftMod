...
public final class BuildCatalogue {
    ...
    public static final List<BuildingType> DEFAULT = List.of(
            ...
            new BuildingType("kingdoms:cottage",        16,      1,     0,            0,        0,        3,       0, 9),
            new BuildingType("kingdoms:mill",           30,      1,     0,            0,        0,        0,       0, 9),
            new BuildingType("kingdoms:carpentry",      30,      1,     0,            0,        0,        0,       0, 9),
            new BuildingType("kingdoms:inn",            35,      1,     0,            0,        0,        0,       0, 11),
