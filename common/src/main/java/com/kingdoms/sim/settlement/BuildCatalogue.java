...
public final class BuildCatalogue {
    ...
    public static final List<BuildingType> DEFAULT = List.of(
            ...
            new BuildingType("kingdoms:town_hall",      40,      1,     1,            0,      100,        0,       0, 15),
            new BuildingType("kingdoms:house",          20,      1,     1,            3,       80,        4,       0, 13),
            new BuildingType("kingdoms:granary",        25,      4,     1,           20,       75,        0,       0, 11),
            new BuildingType("kingdoms:farm",           45,      4,     0,            6,       70,        0,       0, 17),
            ...
            new BuildingType("kingdoms:lumber_camp",    30,      5,     1,           30,       68,        0,       0, 11),
            new BuildingType("kingdoms:mine",           35,      8,     1,           30,       66,        0,       0, 11),
            new BuildingType("kingdoms:warehouse",      35,      6,     1,           25,       64,        0,       0, 13),
            new BuildingType("kingdoms:market",         30,      6,     1,           25,       62,        0,       0, 11),
            new BuildingType("kingdoms:smith",          40,     10,     1,           40,       57,        0,       0, 11),
            new BuildingType("kingdoms:animal_farm",    45,     10,     1,           40,       56,        0,       0, 21),
            new BuildingType("kingdoms:watchtower",     45,     12,     0,           12,       60,        0,       3, 9),
            new BuildingType("kingdoms:storehouse",     30,      6,     1,           15,       55,        0,       0, 11),
            new BuildingType("kingdoms:workshop",       35,      8,     0,            8,       50,        0,       0, 11)
    );
}
