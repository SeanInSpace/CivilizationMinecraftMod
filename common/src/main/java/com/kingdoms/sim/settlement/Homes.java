...
public final class Homes {
    ...
    private static final Map<String, String> WARHOST = Map.of(
            "kingdoms:cottage", "kingdoms:hut",
            "kingdoms:house", "kingdoms:hut",
            "kingdoms:longhouse", "kingdoms:great_hut",
            "kingdoms:croft", "kingdoms:great_hut");
    ...
    private static Map<String, Map<String, String>> instead() {
        ...
        table.put("kingdoms:orc/warhost", WARHOST);
     ...
     * Matched on the base id, so a save holding {@code kingdoms:cottage_l2}
     * resolves the same as a fresh {@code kingdoms:cottage}.
     */
