...
class BlueprintPlacerFloorTest {
    ...
    private static final String HOUSE = "civilization:house";
    private static final String FARM = "civilization:farm";
    ...
    void aFieldSitsWhereAPlayerWouldTill() {
        ...
        assertEquals(64, BlueprintPlacer.baseFor("civilization:norman/farm_l2", 64),
                "whatever level or style the field is built in");
        assertEquals(63, BlueprintPlacer.baseFor("civilization:animal_farm", 64),
