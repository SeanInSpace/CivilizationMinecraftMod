...
import com.kingdoms.neoforge.net.TownMapPayload.Dot;
import com.kingdoms.neoforge.net.TownMapPayload.Line;
import com.kingdoms.neoforge.net.TownMapPayload.Note;
import com.kingdoms.neoforge.net.TownMapPayload.Order;
import com.kingdoms.neoforge.net.TownMapPayload.Overview;
import com.kingdoms.neoforge.net.TownMapPayload.Plot;
import com.kingdoms.neoforge.net.TownMapPayload.Run;
import com.kingdoms.neoforge.net.TownMapPayload.Vertex;
import com.kingdoms.neoforge.net.TownMapRequestPayload;
...
import static com.kingdoms.neoforge.client.KingdomsPanel.RULE;
import static com.kingdoms.neoforge.client.KingdomsPanel.STRIPE;
...
public final class TownMapScreen extends Screen {
    ...
    private int bodyTop() {
        return top() + KingdomsPanel.HEADER;
    }

    private int bodyHeight() {
        return panelHeight() - KingdomsPanel.HEADER - FOOTER;
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
        ...
        KingdomsPanel.frame(graphics, x, y, w, h, PANEL);
        KingdomsPanel.header(graphics, font, x, y, w, title,
                Component.literal(subtitle()), alarmColor(town.overview().distress().alarm()));

        drawMap(graphics);
        drawSide(graphics, mouseX, mouseY);

        KingdomsPanel.rule(graphics, x, y + h - FOOTER + 3, w);
    ...
    /**
     * A blueprint id as a name: {@code kingdoms:orc/great_hut_l2} is "Great hut".
     *
