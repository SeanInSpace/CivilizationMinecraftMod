 ...
 * omits this".
 */
public final class CivilizationCodecs {

    private CivilizationCodecs() {
    }
    ...
    ).apply(i, CivilizationCodecs::perimeterOf));
    ...
    private static Perimeter perimeterOf(
            List<com.civilization.sim.geom.SimPos> vertices,
            List<com.civilization.sim.geom.SimPos> gates, int laid,
