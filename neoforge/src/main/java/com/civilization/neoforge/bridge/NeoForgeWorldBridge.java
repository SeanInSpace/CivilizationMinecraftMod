...
public final class NeoForgeWorldBridge implements WorldBridge {
    ...
    public boolean isSiteLevelable(SimPos plot, int radius) {
        ...
        return oracle.bulkFall(plot.x(), plot.z(), radius, TerrainOracle.GRAIN)
                <= com.civilization.sim.settlement.BuildPlanner.LEVELABLE_FALL;
    }
     ...
     */
    @Override
    public com.civilization.sim.settlement.Building.Authored authoredFacts(
    ...
    public Footprint materializeBlueprint(String blueprintId, SimPos origin, boolean surveyed,
        ...
        CivilizationMod.LOGGER.info("Materialized {} at {} (origin {}, surveyed {})",
     ...
     *
     * <p>See {@link com.civilization.neoforge.world.Woodland}. Runs once, from the
    ...
    public int plantGrownTrees(java.util.List<SimPos> spots, int wanted) {
        int planted = com.civilization.neoforge.world.Woodland.plant(level, spots, wanted);
        if (planted > 0) {
            CivilizationMod.LOGGER.info("Grew {} trees for a seeded lumber camp", planted);
        }
        return planted;
    }
    ...
    public int repairBlueprint(String blueprintId, SimPos origin, int facing) {
        ...
        if (mended > 0) {
            CivilizationMod.LOGGER.info("Mended {} at {} — {} blocks put back",
    ...
    public void log(String message) {
        CivilizationMod.LOGGER.info(message);
    }
