...
public final class TownAuditor {
     ...
     *
     * <p>{@link com.civilization.sim.settlement.RepairPlanner#SEVERE_DAMAGE} is the
    ...
    public static List<String> selfTest() {
        ...
        Building house = plot("civilization:house", 0, 0, 5, 5);
        Building smith = plot("civilization:smith", 1, 1, 5, 5);
        ...
        auditOverlaps(List.of(house, plot("civilization:smith", 500, 500, 5, 5)), setApart);
        check(lines, setApart.isEmpty(), "plots set well apart are left alone");

        Building unsurveyed = new Building("civilization:house", new SimPos(0, 64, 0), 1, true);
