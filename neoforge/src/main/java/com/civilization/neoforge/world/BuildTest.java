...
public final class BuildTest {
    ...
    private static final String[] PROGRAM = {
            "civilization:town_hall", "civilization:market", "civilization:granary",
    ...
    private static final String[] DWELLINGS = {
            "civilization:house", "civilization:house", "civilization:cottage", "civilization:longhouse",
            "civilization:house", "civilization:cottage", "civilization:croft", "civilization:bunkhouse",
    };
    ...
    public static int start(ServerLevel level, SimPos center, int count,
        ...
        town.setCultureId("civilization:orc/warhost");
        ...
        Kingdom kingdom = new Kingdom(Kingdom.Id.random(), "Buildtest", "civilization:orc/warhost");
        kingdom.restoreSettlement(town);
        var world = CivilizationMod.simulationFor(level);
        if (world != null) {
        ...
        CivilizationMod.LOGGER.info("BUILDTEST street runs to pave: {}, within {} of a house",
                toPave.size(), SERVES);
        return pending.size();
    }
    ...
    private boolean step() {
        ...
        if (pending.isEmpty()) {
            ...
            CivilizationMod.LOGGER.info("BUILDTEST done, {} buildings and {} stretches",
                    placed, paved);
            CivilizationSavedData.get(level).setDirty();
            return true;
        }
        ...
        CivilizationMod.LOGGER.info("BUILDTEST placed {} {} at {},{},{} facing {} size {}x{}",
    ...
    private SimPos againstTheCurb(Placement placement) {
        ...
        double wanted = com.civilization.sim.settlement.PathPlanner.keepoutRound(across);
        if (wanted >= away) {
