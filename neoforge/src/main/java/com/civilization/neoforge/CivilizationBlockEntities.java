...
import com.civilization.neoforge.block.StoreChestBlockEntity;
 ...
 */
public final class CivilizationBlockEntities {

    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, CivilizationMod.MOD_ID);
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<StoreChestBlockEntity>>
            STORE_CHEST = BLOCK_ENTITIES.register("store_chest",
                    () -> new BlockEntityType<>(
                            ...
                            CivilizationBlocks.WAREHOUSE.get(),
                            CivilizationBlocks.STOREHOUSE.get()));

    private CivilizationBlockEntities() {
    }
}
