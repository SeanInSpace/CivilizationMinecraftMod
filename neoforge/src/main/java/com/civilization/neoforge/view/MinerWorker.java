...
public final class MinerWorker {
     ...
     *
     * <p>Read off {@link com.civilization.sim.settlement.Seam} rather than kept
     ...
     */
    private static final int MAX_DEPTH = com.civilization.sim.settlement.Seam.WORKINGS_DEPTH;
    ...
    public static boolean harvest(ServerLevel level, Settlement settlement,
        ...
        com.civilization.sim.settlement.Building mineBuilding = settlement.buildingWithRole(
                com.civilization.sim.settlement.BuildingRole.MINE);
        if (mineBuilding != null) {
            com.civilization.sim.world.SimWorld simWorld =
                    com.civilization.neoforge.CivilizationMod.simulationFor(level);
